...
#
# Example
# Manifest: skopeo inspect docker://k8s.gcr.io/build-image/debian-base:bullseye-v1.4.3
# Arches: skopeo inspect --raw docker://k8s.gcr.io/build-image/debian-base:bullseye-v1.4.3
_DEBIAN_BASE_DIGEST = {
...
#
# Example
# Manifest: skopeo inspect docker://k8s.gcr.io/build-image/debian-iptables:bullseye-v1.5.3
# Arches: skopeo inspect --raw docker://k8s.gcr.io/build-image/debian-iptables:bullseye-v1.5.3
