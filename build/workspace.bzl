...
#
# Example
# Manifest: skopeo inspect docker://k8s.gcr.io/build-image/debian-base:bullseye-v1.4.2
# Arches: skopeo inspect --raw docker://k8s.gcr.io/build-image/debian-base:bullseye-v1.4.2
_DEBIAN_BASE_DIGEST = {
